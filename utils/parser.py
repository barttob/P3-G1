...
class Parser():
    def __init__(self, file_path):
        ...
        self.svg_to_mm = 0.3527772388125518
    ...
    def points_on_line(self, line):
        self.svg_parse_points.append(Point(int(line.start.real * self.svg_to_mm * 100), int(line.end.real * self.svg_to_mm * 100)))
    ...
    def parse_dxf(self):
        ...
        svg_str = self.remove_first_rect_and_ungroup(svg_str)
    ...
    def remove_first_rect_and_ungroup(self, svg_string):
